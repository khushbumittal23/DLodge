...
(function(e){
	...
	function i(n){
		...
		if(h){
			...
			c===undefined?p():o.fn(c===false);return true
		}
		else{
			p()
		}
	...
	var t={},
	n="doTimeout",r=Array.prototype.slice;
	e[n]=function(){
...
$(".animatedClick").click(function(){
	...
	if($(this).attr("data-sequence")!=undefined){
		...
		if($("."+e+"[data-id="+r+"]").hasClass("go")){
			$("."+e+"[data-id="+r+"]").addClass("goAway");$("."+e+"[data-id="+r+"]").removeClass("go")
		}
		else{
...
$(document.body).on("appear",".animatedParent",function(e,t){
	...
	if(r.attr("data-sequence")!=undefined){
		...
		var s=i;var o=$(this).find(".animated:last").attr("data-id");
